...
ACTION_SPEC = 'actions/specs/scout_action.json'
SCENE_CONFIG = 'configs/scenes/scout_scene.json'
OUTPUT_DIR = 'actions/trained/scout'
NUM_ENVS = 64
...
PROGRESS_BAR = True
USE_SWANLAB = True
SWANLAB_PROJECT = 'tank-scout-skill'
