...
ACTION_SPEC = 'actions/specs/guard_action.json'
SCENE_CONFIG = 'configs/scenes/guard_scene.json'
OUTPUT_DIR = 'actions/trained/guard'
NUM_ENVS = 64
...
PROGRESS_BAR = True
USE_SWANLAB = True
SWANLAB_PROJECT = 'tank-guard-skill'
