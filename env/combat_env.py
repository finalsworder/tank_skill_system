...
class CombatEnv:
    ...
    def _build_events(self, red_id, task_values, termination_spec):
        ...
        return {
            ...
            'heading_align_to_target_point': heading_align,
            'forward_speed': float(forward_speed),
            'progress_to_selected_enemy': progress_to_selected_enemy,
            'selected_enemy_proximity': selected_enemy_proximity,
            'aim_align_selected_enemy': aim_align_selected_enemy,
            ...
            'selected_ally_under_observation': selected_ally_under_observation,
